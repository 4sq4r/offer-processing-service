...
public class PriceListProcessor {
    ...
    private final FileStrategyProvider fileStrategyProvider;
    ...
    public PriceListEntity uploadPriceList(String merchantId, MultipartFile file) throws CustomException {
        ...
        MinioMetaData minioMetaData = minioService.uploadFile(file);
        PriceListEntity priceListEntity = priceListService.savePriceList(
                merchantEntity,
                file,
                minioMetaData.getFileName(),
                minioMetaData.getUrl(),
                minioMetaData.getFormat()
        );
